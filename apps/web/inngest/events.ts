...
export const events = {
  ...
  visualsRebriefRequested: eventType('visuals/rebrief.requested', {
    schema: VisualsRebriefRequestedSchema,
  }),
  ...
  teaserShotsRequested: eventType('teaser/shots.requested', {
    schema: TeaserShotsRequestedSchema,
  }),
